...
export default function DonorChatbot() {
  ...
  const [messages, setMessages] = useState([
    { sender: "bot", text: "Hi 👋 I'm Veda!\nHow can I help you today? Ask me anything about creating schemes, managing applications, donor settings, or your dashboard.\n\nYou can also send a screenshot 📎 and I'll help you understand it!" },
  ]);
  ...
  const sendMessage = useCallback(async (text, imageOverride, isVoice = false) => {
    ...
    if (image) {
      ...
      if (text && text.trim()) {
        ...
        parts.push({ type: "text", text: "What do you see in this image? Help me understand it in the context of the VidyaSetu donor portal." });
      }
    ...
    try {
      const res = await fetch(`${API}/api/donor-chat`, {
        method: "POST",
